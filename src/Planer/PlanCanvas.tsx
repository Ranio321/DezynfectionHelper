...
import { itemList } from "./Components/Sidebar/Items";
    ...
    <div id="planer">
      ...
      >
        ...
        <CustomCircle x = {currentMousePosition.x} y = {currentMousePosition.y} radius = {10} fill = "black"/>
          ...
          {isDrawing && shouldDrawLine() &&  <CustomLine snapToGrid key = "drawinLine" points = {[drawingLine.start.x, drawingLine.start.y, drawingLine.end.x, drawingLine.end.y]} stroke = "blue" />}
